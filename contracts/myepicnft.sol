  ...
  // string[] firstWords = ["yellow", "moon", "even", "exists", "inmy", "dreams"];
  // string[] secondWords = ["how", "are", "other", "planets", "coping", "up"];
  // string[] thirdWords = ["you", "dont", "know", "you", "are", "beautiful"];
